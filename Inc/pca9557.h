...
#define PCA9557_KEY_LED_1_8_ADDRESS         0x1f
#define PCA9557_KEY_LED_9_16_ADDRESS        0x1e
#define PCA9557_KEY_LED_17_24_ADDRESS       0x1c
...
#define IIC_SCK_OUT()   {IIC_SCL_GPIO_Port->CRL &= ~(0x0f000000);IIC_SCL_GPIO_Port->CRL|=0x0d000000;}
#define IIC_SCK_HIGH()  {IIC_SCL_GPIO_Port->BSRR = IIC_SCL_Pin;}
#define IIC_SCK_LOW()   {IIC_SCL_GPIO_Port->BRR = IIC_SCL_Pin;}

#define IIC_SDA_OUT()   {IIC_SDA_GPIO_Port->CRL &= ~(0xf0000000);IIC_SDA_GPIO_Port->CRL|=0xd0000000;}
#define IIC_SDA_IN()    {IIC_SDA_GPIO_Port->CRL &= ~(0xf0000000);IIC_SDA_GPIO_Port->CRL|=0x20000000;}
